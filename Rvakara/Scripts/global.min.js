...
(function (e, t) {
    ...
    function (e, t) {
        ...
        i.filters = St.prototype = i.pseudos, i.setFilters = new St, l(), ut.attr = b.attr, b.find = ut, b.expr = ut.selectors, b.expr[":"] = b.expr.pseudos, b.unique = ut.uniqueSort, b.text = ut.getText, b.isXMLDoc = ut.isXML, b.contains = ut.contains
    }(e);
    var ot = /Until$/,
...
(function (e) {
    e.widget("ui.draggable", e.ui.mouse, {
        ...
        drag: function (t, n) {
            ...
            for (c = p.snapElements.length - 1; c >= 0; c--) u = p.snapElements[c].left, a = u + p.snapElements[c].width, f = p.snapElements[c].top, l = f + p.snapElements[c].height, m > u - v && a + v > m && y > f - v && l + v > y || m > u - v && a + v > m && b > f - v && l + v > b || g > u - v && a + v > g && y > f - v && l + v > y || g > u - v && a + v > g && b > f - v && l + v > b ? ("inner" !== d.snapMode && (r = v >= Math.abs(f - b), i = v >= Math.abs(l - y), s = v >= Math.abs(u - g), o = v >= Math.abs(a - m), r && (n.position.top = p._convertPositionTo("relative", {
...
$(function () {
    function e() {
        ...
        $("div.point.player1").each(function () {
            $(this).find("div.piece").last().draggable({
                revert: "invalid",
                start: function (t, n) {
                    var r = $(this).parent().attr("data-id");
                    $("div.die.active").each(function () {
                        $("div.point[data-id=" + (r - $(this).attr("data-value")) + "]").droppable({
                            drop: function (t, n) {
                                var r = $(n.draggable).remove();
    ...
    function t(e) {
        $message = $("#message");
        $message.is(":visible") && $message.fadeOut();
    ...
    $("div.die").click(function () {
        ...
        for (var t = 0; t < 3; t++) {
            ///TODO EDIT
            $($(".die#die" + (t+1)).find('.face')).css('display', 'none');
        
            $(".die#die" + (t+1)).addClass("active").attr("data-value", (Game.GameTable.Dices[t]-1));
            $($(".die#die" + (t + 1)).find('.face')[Game.GameTable.Dices[t]-1]).css('display', 'initial');
            e()
        }
    });
    jQuery.fn.shake = function () {
        this.each(function (e) {
            ...
            for (var n = 1; n <= 2; n++) $(this).animate({
                left: t - 25
            }, 10).animate({
                left: t
            }, 50).animate({
